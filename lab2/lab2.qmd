...
В результате лабораторной работы мы получили практические навыки использования языка программирования "R" для обработки данных и знания базовых типов данных языка R

## Вывод

Итого, мы получили практические навыки использования функций обработки данных пакета dplyr, а именно функций `select()`, `filter()`, `mutate()`, `arrange()`, `group_by()`
