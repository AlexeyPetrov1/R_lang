...
1.  Операционная система Майкрософт Windows 11 Pro Версия	10.0.26200 Сборка 26200
2.  Yandex Query
3.  Бакет arrow-datasets в Yandex Object Storage
...
3.  Автоматически назначить типы колонок, и уточнить формат Timestamp
...
В данной работе я изучил принципы работы в Yandex Cloud, протоколом s3, а также с Yandex Query.
